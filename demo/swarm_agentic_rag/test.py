...
def test_used_tool():
    with trace.as_context():
        ...
        it.assert_true(len(trace.tool_calls()) == 1, 'The calendar tool should only be used once', assertion_type='SOFT')
...
def test_correct():
    with trace.as_context():
        ...
        it.assert_true('0:30' in trace.messages(-1)['content'])#, 'The result should be 1:00')
